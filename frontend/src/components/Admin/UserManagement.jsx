...
const UserManagement = () => {
    ...
    const handleDeleteUser = (userId) => {
        if (window.confirm("Are you sure you want to delete this user?")) {
            console.log(userId,'deleting user with id');
            ...
            <div className='p-6 rounded-lg mb-6'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-4'>
                        ...
                        <input type="password" name='password' value={formData.name} onChange={handleChange}
                            className='w-full p-2 border rounded'
                            required />
                    </div>
                    <div className='mb-4'>
                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user._id} className='border-b hover:bg-gray-50'>
                                ...
                                <td className='p-4'><select name="" value={user.role} onChange={(e) => handleRoleChange(user._id, e.target.value)}
